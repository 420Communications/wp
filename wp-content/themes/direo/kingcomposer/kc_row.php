...
<section <?php echo implode(' ', $element_attributes); ?>>
    <div class="<?php echo esc_attr(implode(' ', $cont_class)); ?>">
        <div class="kc-wrap-columns">
            <?php echo do_shortcode(str_replace('kc_row#', 'kc_row', $content)); ?>
        </div>
    </div>
</section>
