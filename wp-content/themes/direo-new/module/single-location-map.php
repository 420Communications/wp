<?php
/*==========================================
    Element Name: Single Location Map
    ...
    kc_add_map(
        array(
            'single-location-map' => array(
                'name' => esc_html__('Single Location Map View', 'direo'),
                'icon' => 'far fa-map',
                'category' => 'Direo',
                'priority' => 116,
                'params' => array(
                    'general' => array(
                        ...
                        array(
                            ...
                            'type' => 'multiple',
                            'options' => is_Directorist() ? direo_listing_tags() : [],
                        ),
                        array(
                            'name' => 'location',
                            ...
                            'type' => 'multiple',
                            'options' => is_Directorist() ? direo_listing_locations() : [],
                        ),
                        array(
                            'name' => 'featured',
