<?php
/*==========================================
    Element Name: Need Single Category
...
if (function_exists('kc_add_map')) {
    kc_add_map(
        array(
            'need-single-cat' => array(
                'name' => esc_html__('Needs Single Category', 'direo'),
                'description' => esc_html__('Display your needs by category.', 'direo'),
                'icon' => 'fas fa-tag',
                'category' => 'Need',
                'priority' => 117,
                'params' => array(
