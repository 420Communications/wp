...
<?php if ($bdmv_listings->column_is(3)) { ?>
    ...
    <div id="directorist" class="directorist-wrapper"
        ...
        <?php direo_get_template_part( 'directorist/custom/map-listing-type', $bdmv_listings ); ?>

        <div class="directorist-map-wrapper directorist-map-columns-three">

            <div class="directorist-map-search-inner">

                <h2 class="directorist-listing-map-title" data-post-id="<?php echo get_the_ID(); ?>">
                    <?php echo direo_lwm_get_the_title( get_the_ID() ); ?>
                </h2>
            ...
            <div class="directorist-res-btns">
                <a href="" class="directorist-res-btn" id="js-dlm-search"><?php directorist_icon( 'la la-search' ); ?></a>
                <a href="" class="directorist-res-btn active" id="js-dlm-listings"><?php directorist_icon( 'la la-list-ul' ); ?></a>
                <a href="" class="directorist-res-btn" id="js-dlm-map"><?php directorist_icon( 'la la-map-o' ); ?></a>
            </div>
        </div>
    </div>
