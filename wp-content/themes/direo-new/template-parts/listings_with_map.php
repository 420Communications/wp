...
$login_button         = get_theme_mod( 'login_btn', 'Login' );
?>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<?php echo direo_get_template_part( 'template-parts/login-modal-fields' ); ?>
				</div>
		...
		<div class="modal-dialog modal-dialog-centered">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					echo direo_get_template_part( 'directorist/registration-modal-fields', $args );?>
