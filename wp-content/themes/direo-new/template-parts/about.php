...
$icon         = class_exists( 'Directorist_Base' ) ? directorist_icon( 'la la-youtube-play', false ) : '';
?>
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-5 col-md-6">
					...
					echo ! empty( $btn ) && $video ? sprintf( '<a href="%s" class="video-iframe play-btn-two"> <span class="icon">%s</span> <span>%s</span> </a>', esc_url( $video ), $icon, esc_attr( $btn ) ) : '';
					?>
				</div>
				<?php
