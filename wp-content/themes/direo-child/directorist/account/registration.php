					...
					<form action="<?php the_permalink(); ?>" method="post">
						...
						<?php if ( ! empty( get_directorist_option( 'display_user_type' ) ) ) {
							...
							<div class="atbd_user_type_area directory_regi_btn directorist-radio directorist-radio-circle directorist-mb-15">
								<input id="author_type" type="radio" name="user_type" value="author" <?php echo esc_attr( $author_checked ); ?>><label for="author_type" class="directorist-radio__label"><?php esc_html_e( 'I am an Seller', 'directorist' ); ?>
							</div>
							<?php } ?>
							<?php if ( empty( $user_type ) || 'general' == $user_type ) { ?>
							<div class="atbd_user_type_area directory_regi_btn directorist-radio directorist-radio-circle directorist-mb-15">
								<input id="general_type" type="radio" name="user_type" value="general" <?php echo esc_attr( $general_checked ); ?>><label for="general_type" class="directorist-radio__label"><?php esc_html_e( 'I am a Buyer', 'directorist' ); ?>
							</div>
							<?php } ?>
							<?php if ( empty( $user_type ) || 'dispensary' == $user_type ) { ?>
							<div class="atbd_user_type_area directory_regi_btn directorist-radio directorist-radio-circle directorist-mb-15">
								<input id="dispensary_type" type="radio" name="user_type" value="dispensary" <?php echo esc_attr( $general_checked ); ?>><label for="dispensary_type" class="directorist-radio__label"><?php esc_html_e( 'I am a Dispensary', 'directorist' ); ?>
							</div>
							<?php } ?>
						<?php } ?>
