...
jQuery('.page.page-current').attr('style', '');
		...
		jQuery('.ps-navbar__menu-item a, .bp-generic-meta a, .member-button-wrap a, a[href*="ajax-call"], .bp-pagination-links a, .ajax_add_to_cart, .rtmedia-list a, .activity-meta a, a[href*="admin-ajax"], .bp-pagination-links.bottom a.next, nav#subnav a, ul.component-navigation.activity-nav a, .product-remove a').each(function(){
