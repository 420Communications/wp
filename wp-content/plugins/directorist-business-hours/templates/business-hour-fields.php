            ...
            <div class="directorist-bh-dayzone__single">
                ...
                <div class="directorist-bh-dayzone__single--choice">
                    ...
                    <div class="directorist-flex directorist-bh-dayzone__single--choice-wrapper">
                        <div class="directorist-select directorist-select--start">
                            <?php echo atbdp_hours( 'bdbh[monday][start][' . $index . ']', !empty( $monday_time ['start'] ) ? $monday_time ['start'] : '', 'open' ); ?>
                        </div>
                        <div class="directorist-select directorist-select--close">
                        ...
                        <div class="directorist-select-copy">
                            <a href="#" class="directorist-btn directorist-btn-sm directorist-btn-outline directorist-select-remove"><i class="la la-trash"></i></a>
                        </div>
                    </div>
                   ...
                   <?php }
                    ...
                    <a href="#" class="directorist-btn directorist-btn-sm directorist-btn-outline directorist-select-add"><i class="la la-plus"></i></a>
                </div>
