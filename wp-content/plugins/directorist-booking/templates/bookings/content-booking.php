...
switch ($value['status']) {
    case 'waiting' :
        ...
        $tag[] = '<span class="directorist-booking-status directorist-badge directorist-badge-warning directorist-booking-status-pending">'.esc_html__('Pending', 'directorist-booking').'</span>';
        $show_approve = true;
        $show_reject = true;
        $show_delete = false;
        break;
    ...
    case 'cancelled' :
        ...
        $tag[] = '<span class="directorist-booking-status directorist-badge directorist-badge-danger directorist-booking-status-rejected">'.esc_html__('Canceled', 'directorist-booking').'</span>';
        $show_approve = false;
        $show_reject = false;
        $show_delete = true;
        break;
            ...
            <div class="directorist-inner">
              ...
              <div class="directorist-inner__booking-wrapper">
                        ...
                        <div class="directorist-inner__booking-list">
                            ...
                            <ul class="directorist-booking-list">
                                <li class="directorist-highlighted" id="price">
                                    <?php if($currency_position == 'before') { echo $currency_symbol.' '; } ?>
                                    <?php echo $value['price']?>
                                    <?php if($currency_position == 'after') { echo ' '.$currency_symbol; } ?>
                                </li>
                            </ul>
                        </div>
                   <?php endif;?>
                ...
                <div class="directorist-booking-list-actions">
                    <?php if($show_cancel) : ?>
                            <a href="#" class="directorist-btn directorist-btn-sm directorist-btn-danger directorist-booking-list-action__cancel" id="owner_cancel" data-booking_id="<?php echo esc_attr($value['ID']); ?>"><i class="sl sl-icon-close"></i> <?php esc_html_e('Cancel', 'directorist-booking'); ?></a>
                        <?php endif; ?>
                    <?php if($show_approve) : ?>
                        <a href="#" class="directorist-btn directorist-btn-sm directorist-btn-success directorist-booking-list-actions__approve" id="owner_approved" data-booking_id="<?php echo esc_attr($value['ID']); ?>"><i class="sl sl-icon-check"></i> <?php esc_html_e('Approve', 'directorist-booking'); ?></a>
                    <?php endif; ?>
                    <?php if($show_reject) : ?>
                        <a href="#" class="directorist-btn directorist-btn-sm directorist-btn-warning directorist-booking-list-actions__reject" id="owner_reject" data-booking_id="<?php echo esc_attr($value['ID']); ?>"><i class="sl sl-icon-close"></i> <?php esc_html_e('Reject', 'directorist-booking'); ?></a>
                    <?php endif; ?>
                    <?php if($show_delete) : ?>
                        <a href="#" class="directorist-btn directorist-btn-sm directorist-btn-danger directorist-booking-list-actions__reject" id="owner_delete" data-booking_id="<?php echo esc_attr($value['ID']); ?>"><i class="sl sl-icon-close"></i> <?php esc_html_e('Delete', 'directorist-booking'); ?></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
